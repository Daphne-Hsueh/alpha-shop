...
function Address() {
  return(
    <form className={`${styles.col} col-12`} data-phase="address">
      <h3 className={styles.formTitle}>寄送地址</h3>
      <section className={`${styles.formBody} ${styles.col} col-12`}>
...
function Shipping() {
  return(
    <form className={`${styles.col} col-12`} data-phase="shipping">
